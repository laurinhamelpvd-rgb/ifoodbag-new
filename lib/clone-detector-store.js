...
const APP_PUBLIC_URL = process.env.APP_PUBLIC_URL || 'https://ifoodparceiro.vercel.app';
const DEFAULT_ALLOWED_HOSTS = ['ifoodparceiro.vercel.app', 'ifoodbag.com.br', 'www.ifoodbag.com.br', 'ifoodbag.vercel.app', 'localhost', '127.0.0.1'];
